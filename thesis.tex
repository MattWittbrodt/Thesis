...
\bibliography{C:/Users/mattw/gdrive/Papers/mattsLibrary}
...
\begin{singlespace}  % use single-line spacing for refs
	\setlength\bibitemsep{\baselineskip}  %separate  betwen items in bibliography to double space
